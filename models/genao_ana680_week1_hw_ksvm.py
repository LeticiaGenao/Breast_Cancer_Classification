# -*- coding: utf-8 -*-
"""Genao_ANA680_Week1_HW_KSVM

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZDFBNu3lcVQA6SMhF5R8jPh13wH1pOmo

# **ANA 680 Week 1 Homework Assignment**
## Leticia Genao
## 05/09/24

### **Method: Kernel SVM (kernel = rbf)**
"""
...
# Initialize and fit Kernel SVM model with RBF kernel
svm_kernel_model = SVC(kernel='rbf')
svm_kernel_model.fit(X_train, y_train)

# Make predictions
svm_kernel_predictions = svm_kernel_model.predict(X_test)

# Evaluate the model
svm_kernel_accuracy = accuracy_score(y_test, svm_kernel_predictions)
svm_kernel_conf_matrix = confusion_matrix(y_test, svm_kernel_predictions)

# Print results
print(f"Accuracy: {svm_kernel_accuracy}")
print(f"Confusion Matrix:\n{svm_kernel_conf_matrix}")
print("Confusion Matrix:")
sns.heatmap(svm_kernel_conf_matrix, annot=True, fmt="d", cmap='Blues', xticklabels=['Benign', 'Malignant'], yticklabels=['Benign', 'Malignant'])
