# -*- coding: utf-8 -*-
"""Genao_ANA680_Week1_HW_LSVM

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1I2QGxuftM4-PRb5u2DltN5uUoHcKuzO6

# **ANA 680 Week 1 Homework Assignment**
## Leticia Genao
## 05/09/24

### **Method: Linear SVM (kernel = linear)**
"""
...
# Initialize and fit Linear SVM model
...
# Print results
print(f"Accuracy: {svm_linear_accuracy}")
print(f"Confusion Matrix:\n{svm_linear_conf_matrix}")
print("Confusion Matrix:")
sns.heatmap(svm_linear_conf_matrix, annot=True, fmt="d", cmap='Blues', xticklabels=['Benign', 'Malignant'], yticklabels=['Benign', 'Malignant'])
